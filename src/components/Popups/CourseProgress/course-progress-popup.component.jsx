...
function CourseProgressPopup(props) {
  return (
    <>
      <div className="course-progress-back" style={props.courseProgress?{opacity:"1",pointerEvents:"visible"}:{}}></div>
      <div className="course-progress-popup" style={props.courseProgress?{opacity:"1",pointerEvents:"visible"}:{}}>
      <i class="fa fa-times-circle mb-3" aria-hidden="true" onClick={()=> props.showProgressPopup({courseProgress: false})}></i>
        ...
        <div className="course-score_container d-flex justify-content-center align-items-center">
          ...
          <div className="course-score">
            <h5 className="course-score_header">Your score</h5>
        ...
        <h2 className="universal-course mb-4">Universal Course</h2>
        <div className="course-completion-details">
            ...
            <div className="d-flex">
                ...
                <div className="assignments completion-detail">
                    ...
                    <h5 className="completion-text">
                    Assignments: <span className="score">5/5</span>
                    </h5>
                </div>
            </div>
        </div>
