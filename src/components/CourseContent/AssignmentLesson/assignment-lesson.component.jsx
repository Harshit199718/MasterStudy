...
export class AssignmentLesson extends Component {
  ...
  render() {
    const { startAssignment, showRequirements, sendAttachments,attachments } = this.state;
    return (
      <div
          ...
          <>
            ...
            {showRequirements ? (
              <div className="assignment-requirements mt-2">
                <p>Dear students, you can send your homework in this lesson</p>
            ...
            {startAssignment ? (
              <div className="text-editor_container">
                <TextEditor setAttachments={(obj)=>this.setState(obj)} />
                <div className="attach-files-btn_container mt-3">
                  <button className="attach-files-btn text-uppercase">
                    {" "}
                    <i className="fa fa-paperclip mr-1"></i> Attach Files
                  </button>
                  <input type="file" />
                </div>
              </div>
            ...
            {startAssignment ? (
              <button
                onClick={() => this.setState({ sendAttachments: true })}
