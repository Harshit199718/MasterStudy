...
export class AddCourseDesc extends Component {
  ...
  render() {
    const { uploadedImg, courseFile, removeIndex } = this.state;
    var date = new Date()
    return (
      <div className="add-course-desc mb-5">
        <div className="course-img-upload_container d-flex justify-content-center align-items-center">
          <input type="file" name="" id="" onChange={(e) => this.loadFile(e)} />
          ...
          >
            ...
            <h5 className="upload-img-text m-0">Upload course Image</h5>
          </div>
        </div>
        ...
        <div className="course-material_container mt-4">
          <h5 className="course-material_header">Course Materials</h5>
